 ...
 *
 */
public interface PMCContractContext {

    /**
     * @return The Node id of the node that proposed the transaction.
     */
    public PMCNode getProposer();
     ...
     *            field that needs to saved. The @PCName at each field gives
     *            the column name.
     * @throws SQLException
     */
     ...
     *            by insert, a @PCPrimaryKey is needed at the clazz level.
     * @throws SQLException
     */
